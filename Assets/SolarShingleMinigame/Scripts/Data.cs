...
{
    //Static data part of Tetromino shapes. It is essential that this class stays untouched for having healthy dynamics for tetris mini game. 
    ...
    //Wallkick data is only for making sure that tetris pieces do not fall off or go out of the border. This one is specifically for I since its unique by shape
    ...
    //Wallkick data is only for making sure that tetris pieces do not fall off or go out of the border. This one is for the rest of the pieces
