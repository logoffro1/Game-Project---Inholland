...
Shader "FastWaterLowPoly/WaterHDRP"
{
	Properties
	{
		...
		_DepthRange1("DepthRange", Range( 0 , 1)) = 0
		...
		[ASEEnd]_LowPolyToFlat1("LowPolyToFlat", Range( 0 , 1)) = 0.8
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 temp_output_69_0 = ( float4( inputMesh.positionOS , 0.0 ) + appendResult51 );
				
				float3 vertexPos13 = temp_output_69_0.xyz;
				float4 ase_clipPos13 = TransformWorldToHClip( TransformObjectToWorld(vertexPos13));
				float4 screenPos13 = ComputeScreenPos( ase_clipPos13 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord5 = screenPos13;
				float3 vertexPos28 = temp_output_69_0.xyz;
				float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
				float4 screenPos28 = ComputeScreenPos( ase_clipPos28 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord6 = screenPos28;
				...
				#endif
				float3 vertexValue = temp_output_69_0.xyz;
						...
						)
			{
				...
				float4 screenPos13 = packedInput.ase_texcoord5;
				...
				float screenDepth13 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm13.xy ),_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 normalizeResult93 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
				float3 lerpResult95 = lerp( normalizeResult93 , normalWS , _LowPolyToFlat1);
				float lerpResult17 = lerp( distanceDepth13 , ( distanceDepth13 * ( 1.0 - (lerpResult95).y ) ) , 0.998);
				float4 screenPos28 = packedInput.ase_texcoord6;
				...
				float screenDepth28 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm28.xy ),_ZBufferParams);
				float distanceDepth28 = abs( ( screenDepth28 - LinearEyeDepth( ase_screenPosNorm28.z,_ZBufferParams ) ) / ( _Depth ) );
				float lerpResult85 = lerp( distanceDepth28 , (0.5 + (distanceDepth28 - -1.0) * (1.0 - 0.5) / (1.0 - -1.0)) , _DepthRange1);
				float clampResult32 = clamp( lerpResult85 , 0.0 , 1.0 );
				...
				float3 worldToTangentDir97 = mul( ase_worldToTangent, lerpResult95);
				...
				float4 clampResult39 = clamp( ( ifLocalVar35 + lerpResult33 ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				
				surfaceDescription.Albedo = ifLocalVar7.rgb;
				surfaceDescription.Normal = worldToTangentDir97;
				...
				surfaceDescription.Alpha = clampResult39.r;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 ase_clipPos13 = TransformWorldToHClip( TransformObjectToWorld(vertexPos13));
				float4 screenPos13 = ComputeScreenPos( ase_clipPos13 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord = screenPos13;
				...
				float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
				float4 screenPos28 = ComputeScreenPos( ase_clipPos28 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord3 = screenPos28;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 screenPos13 = packedInput.ase_texcoord;
				float4 ase_screenPosNorm13 = screenPos13 / screenPos13.w;
				ase_screenPosNorm13.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm13.z : ase_screenPosNorm13.z * 0.5 + 0.5;
				float screenDepth13 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm13.xy ),_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
				...
				float3 lerpResult95 = lerp( normalizeResult93 , ase_worldNormal , _LowPolyToFlat1);
				float lerpResult17 = lerp( distanceDepth13 , ( distanceDepth13 * ( 1.0 - (lerpResult95).y ) ) , 0.998);
				float4 screenPos28 = packedInput.ase_texcoord3;
				float4 ase_screenPosNorm28 = screenPos28 / screenPos28.w;
				ase_screenPosNorm28.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm28.z : ase_screenPosNorm28.z * 0.5 + 0.5;
				float screenDepth28 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm28.xy ),_ZBufferParams);
				float distanceDepth28 = abs( ( screenDepth28 - LinearEyeDepth( ase_screenPosNorm28.z,_ZBufferParams ) ) / ( _Depth ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 ase_clipPos13 = TransformWorldToHClip( TransformObjectToWorld(vertexPos13));
				float4 screenPos13 = ComputeScreenPos( ase_clipPos13 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord1 = screenPos13;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = ase_worldNormal;
				float3 vertexPos28 = temp_output_69_0.xyz;
				float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
					...
					)
			{
				...
				float4 screenPos13 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm13 = screenPos13 / screenPos13.w;
				ase_screenPosNorm13.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm13.z : ase_screenPosNorm13.z * 0.5 + 0.5;
				float screenDepth13 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm13.xy ),_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 ase_clipPos13 = TransformWorldToHClip( TransformObjectToWorld(vertexPos13));
				float4 screenPos13 = ComputeScreenPos( ase_clipPos13 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord4 = screenPos13;
				float3 vertexPos28 = temp_output_69_0.xyz;
				float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
				float4 screenPos28 = ComputeScreenPos( ase_clipPos28 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord5 = screenPos28;
					...
					)
			{
				...
				float4 screenPos13 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm13 = screenPos13 / screenPos13.w;
				ase_screenPosNorm13.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm13.z : ase_screenPosNorm13.z * 0.5 + 0.5;
				float screenDepth13 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm13.xy ),_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
				...
				if( lerpResult17 <= _SizeFoam )
				ifLocalVar35 = _ColorFoam;
				float4 screenPos28 = packedInput.ase_texcoord5;
				float4 ase_screenPosNorm28 = screenPos28 / screenPos28.w;
				ase_screenPosNorm28.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm28.z : ase_screenPosNorm28.z * 0.5 + 0.5;
				float screenDepth28 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm28.xy ),_ZBufferParams);
				float distanceDepth28 = abs( ( screenDepth28 - LinearEyeDepth( ase_screenPosNorm28.z,_ZBufferParams ) ) / ( _Depth ) );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 ase_clipPos13 = TransformWorldToHClip( TransformObjectToWorld(vertexPos13));
				float4 screenPos13 = ComputeScreenPos( ase_clipPos13 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord7 = screenPos13;
				float3 vertexPos28 = temp_output_69_0.xyz;
				float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
				float4 screenPos28 = ComputeScreenPos( ase_clipPos28 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord8 = screenPos28;
				...
				)
			{
				...
				float4 screenPos13 = packedInput.ase_texcoord7;
				float4 ase_screenPosNorm13 = screenPos13 / screenPos13.w;
				ase_screenPosNorm13.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm13.z : ase_screenPosNorm13.z * 0.5 + 0.5;
				float screenDepth13 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm13.xy ),_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
				...
				if( lerpResult17 <= _SizeFoam )
				ifLocalVar35 = _ColorFoam;
				float4 screenPos28 = packedInput.ase_texcoord8;
				float4 ase_screenPosNorm28 = screenPos28 / screenPos28.w;
				ase_screenPosNorm28.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm28.z : ase_screenPosNorm28.z * 0.5 + 0.5;
				float screenDepth28 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm28.xy ),_ZBufferParams);
				float distanceDepth28 = abs( ( screenDepth28 - LinearEyeDepth( ase_screenPosNorm28.z,_ZBufferParams ) ) / ( _Depth ) );
...
/*ASEBEGIN
Version=18800
0;0;1920;1019;-1964.269;77.24152;1.787191;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;45;694.0103,1361.929;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;44;1022.704,1499.557;Float;False;Property;_Speed;Speed;11;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;1161.892,1382.505;Float;False;Property;_ScaleNoise;ScaleNoise;13;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;88;1542.362,5.429002;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TexturePropertyNode;42;1328.067,1034.249;Float;True;Property;_Noise;Noise;10;0;Create;True;0;0;0;False;0;False;None;eaa1c5562af66424092dc5b1f37208e9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;53;2025.855,1166.695;Inherit;True;Property;_TextureSample0;Texture Sample 0;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;50;2246.665,1406.527;Float;False;Property;_NoiseIntensity;NoiseIntensity;12;0;Create;True;0;0;0;False;0;False;0;0.15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DdxOpNode;89;1927.362,-99.57104;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DdyOpNode;90;1890.362,75.42901;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;57;2739.304,1503.169;Float;False;Constant;_Float0;Float 0;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CrossProductOpNode;91;2163.662,12.72899;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;70;2993.294,1184.135;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WorldNormalVector;94;2894.902,-58.6211;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalizeNode;93;2491.362,58.12899;Inherit;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;92;2802.562,489.8638;Inherit;False;Property;_LowPolyToFlat1;LowPolyToFlat;14;0;Create;True;0;0;0;False;0;False;0.8;0.827;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;95;3319.872,325.2083;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;69;3409.294,1292.135;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-1900.536,1169.134;Float;False;Property;_Depth;Depth;4;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;96;3657.088,224.7586;Inherit;False;False;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;28;-1660.837,1158.034;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-338.7028,135.0336;Float;False;Property;_SizeFoam;SizeFoam;7;0;Create;True;0;0;0;False;0;False;2;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;84;-1809.374,541.2766;Inherit;False;Property;_DepthRange1;DepthRange;5;0;Create;True;0;0;0;False;0;False;0;0.379;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;87;-1368.705,846.3635;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;85;-1231.346,667.344;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;177.0331,599.5805;Float;False;Constant;_Lerp_;Lerp_;0;0;Create;True;0;0;0;False;0;False;0.998;0.998;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;306.5998,787.0221;Float;False;Property;_ColorFoam;Color Foam;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.9931185,0.86,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-800.91,1145.026;Float;False;Property;_OpasityIntensity;OpasityIntensity;6;0;Create;True;0;0;0;False;0;False;1;0.403;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;31;-575.4737,369.9068;Float;False;Property;_ColorDepth;Color Depth;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.05965094,0.10968,0.1607842,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;11;-653.0463,617.0334;Float;False;Property;_Colorwater;Color water;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1058823,0.4798573,0.5607843,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;72;1;97;0
WireConnection;72;5;24;0
WireConnection;72;7;23;0
WireConnection;72;9;39;0
WireConnection;72;11;69;0
ASEEND*/
//CHKSM=E914B4232AED6F229B823504D621706BD070B386